...
export const Revolve = ({switcherColor}) => {
    return(
        <Wrapper id="container" switcherColor={switcherColor}>

            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                viewBox="0 0 200 82.7" style={{enableBackground:'new 0 0 200 82.7'}} xmlSpace="preserve">
                ...
                <g id="Calque_2">
                    ...
                    <path    id="XMLID_5_"  className="st2" d="M103.8,16.7c0.1,0.3,0.1,0.6,0.1,0.9c11.6,1.9,20.4,11.9,20.4,24.1c0,13.5-10.9,24.4-24.4,24.4
